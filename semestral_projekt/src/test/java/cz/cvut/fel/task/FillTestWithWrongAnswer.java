...
public class FillTestWithWrongAnswer implements Task {
    @Override
    @Step("FillTestWithWrongAnswer")
    public <T extends Actor> void performAs(T t) {
        t.attemptsTo(
                ...
                Click.on(By.cssSelector("body > div.site-wrap > div > div > section.column.column-right.task-details.ng-scope > div > div > div:nth-child(2) > section > div > div > div > view > div > div > div.ng-scope > div:nth-child(2) > div > div > div > div > form > div > label:nth-child(16)")),
                ...
                Click.on(By.cssSelector("body > div.site-wrap > div > div > section.column.column-right.task-details.ng-scope > div > div > div:nth-child(2) > section > div > div > div > view > div > div > div.ng-scope > div:nth-child(2) > div > div > div > div > form > div > label:nth-child(27)")),
    ...
    public static Performable fillTest(){
        return Instrumented.instanceOf(FillTestWithWrongAnswer.class).withProperties();
    }
}
